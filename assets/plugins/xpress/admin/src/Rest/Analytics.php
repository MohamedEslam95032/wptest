...
class Analytics
{
    ...
    public function get_active_users($request)
    {
        try {
            ...
            $active_users = $this->get_active_users_count($timezone, $browser_time);
    ...
    public function get_analytics_stats($request)
    {
        ...
        try {
            switch ($stat_type) {
                case 'overview':
                    $data = $this->get_overview_stats($start_date, $end_date, $page_url);
                    break;
                case 'pages':
                    $data = $this->get_pages_stats($start_date, $end_date, $page_url);
                    break;
                case 'referrers':
                    $data = $this->get_referrers_stats($start_date, $end_date);
                    break;
                case 'devices':
                    $data = $this->get_devices_stats($start_date, $end_date);
                    break;
                case 'geo':
                    $data = $this->get_geo_stats($start_date, $end_date);
                    break;
                case 'events':
                    $data = $this->get_events_stats($start_date, $end_date);
                    break;
                default:
